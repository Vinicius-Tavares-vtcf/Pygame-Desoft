...
SFX_MINOTAUR_ENTRY = 'sfx_minotaur_entry'
...
def load_assets():
    ...
    assets[SFX_MINOTAUR_ENTRY] = pygame.mixer.Sound(path.join(SND_DIR, 'combat', 'entradaminotauro.waw.mp3'))
    ...
    assets[SFX_MINOTAUR_ENTRY].set_volume(1.0)
